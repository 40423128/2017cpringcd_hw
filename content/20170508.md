...
<p>台灣,台灣有參與Onshape開發</p>

##1.協同閱讀寫心得(two books)
<p>An Introduction to Agile Product Design</p>
<p>心得:</p>
<p>這一篇主要是在介紹敏捷產品的優點及好處,敏捷的產品主要有推進速度及提高創新這兩大好處,而對於公司的好處共有四大點1.更快的創新2.降低開發成本3.更大的市場份額4.較高的預測精度.</p>
<p>Onshape's Greatest Tech Tips– Volume 1</p>
<p>心得:主要是在介紹onshape的用法,還有onshape與其他市面上的軟體不同的地方,例如共享,分支,版本控制,其中提了10項功能.我覺得比較新穎的用法是多個瀏覽器選項,如果你在其中一個標籤頁做變更,其他的標籤頁也會馬上更新,這個功能目前在眾多的繪圖軟體中,僅onshape有此種功能.</p>
##2.影片觀看心得
...
##3.2D 靜態網際繪圖-3D 減速齒輪組動態模擬
<p>從單一 2D 正齒輪繪圖到齒輪組嚙合利用漸開線原理, 以 Brython 繪製單一正齒輪廓:</p>
<!-- 導入 Brython 標準程式庫 -->
